...
import com.example.administrator.sqlitetableseditor.adapter.ListEmployeesAdapter;
import com.example.administrator.sqlitetableseditor.dao.EmployeeDAO;
import com.example.administrator.sqlitetableseditor.model.Employee;

import java.util.ArrayList;
import java.util.List;

public class ListEmployeesActivity extends Activity implements AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener, View.OnClickListener {

    public static final String TAG = "ListEmployeesActivity";

    public static final int REQUEST_CODE_ADD_EMPLOYEE = 46;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mCompanyId != -1) {
            ...
            // Through adapter fill the ListView
    ...
    private void showDeleteDialogConfirmation(final Employee employee) {
        ...
        alertDialogBuilder
                .setMessage("Make sure you want to delete \""
        ...
        alertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // delete employee and refresh the list
                if(mEmployeeDao != null) {
